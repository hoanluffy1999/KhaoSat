...
public enum RightSideBannerEnum
{
    [Description("Trên phim tài liệu")]
    AboveDocumentary = 1,
    [Description("Dưới phim tài liệu")]
    BelowDocumentary = 2,
    [Description("Trên Slide ảnh")]
    AboveImgSlide = 3,
    [Description("Dưới Slide ảnh")]
    BelowImgSlide = 4,
}
...
public enum AlbumVideoNumber
{
    [Description("Một video")]
    OneVideo = 1,
    [Description("Nhiều video")]
    MoreVideos = 2
